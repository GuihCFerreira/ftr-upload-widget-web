...
export function UploadWidgetUploadItem({ upload, uploadId }: UploadWidgetUploadItemProps) {
  ...
  return (
    ...
    >
      ...
      >
        <Progress.Indicator
          className="bg-indigo-500 h-1 group-data-[status=error]:bg-red-400 group-data-[status=canceled]:bg-yellow-400 group-data-[status=success]:bg-green-400 transition-all"
      ...
      <div className="absolute top-2.5 right-2.5 flex items-center gap-1">
        ...
        <Button
          ...
          asChild
        >
          <a href={`${upload.remoteUrl}?response-content-disposition=attachment;filename=${upload.name}`} download>
